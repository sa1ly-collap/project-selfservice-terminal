...
Далее я спроектировала целевой вариант, где часть операций переносится на терминал самообслуживания: гость сам выбирает способ оплаты, пополняет баланс, а администратор подключается только при нестандартных ситуациях.
